...
// Abstract by outline on 2023/7/5
void SI5351_Init(I2C_HandleTypeDef *hi2c) {
    __hi2c == hi2c;
    I2C_HANDLE = *hi2c;
//    const int32_t correction = (int32_t)+0.007e6;  // black
    const int32_t correction = (int32_t)0.0079e6;  // white
    si5351_Init(correction);
}

/**
 *
 * @param freq0 CLK0 frequency
 * @param freq2 CLK2 frequency
 */
void SI5351_SetCLK02(double freq0, double freq2) {
    si5351_SetupCLK0((int32_t)freq0, SI5351_DRIVE_STRENGTH_4MA);
    si5351_SetupCLK2((int32_t)freq2, SI5351_DRIVE_STRENGTH_4MA);
